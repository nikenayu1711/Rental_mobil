...
<body>
	...
	<div class="container" style="margin-top:20px">
        ...
        <a href="inputmobil.php" class="btn btn-primary mb-3">Tambah Data</a>
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
                            ...
                            <td>'.$data['harga'].'</td>
							<td>
								<a href="editmobil.php?id_mobil='.$data['id_mobil'].'" class="badge badge-warning">Edit</a>
                                <a href="deletemobil.php?id_mobil='.$data['id_mobil'].'"class="badge badge-danger">Delete</a>
							</td>
						</tr>
						';
						$no++;
